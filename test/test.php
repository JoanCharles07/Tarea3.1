...
require __DIR__ . '/../Backend/Modelo/funciones.php';
...
class test extends TestCase {
    ...
    public function testCalcularPedido(){
        $productos=[[1,2,2,4],[2,3,3,9]];
        $this->assertEquals(16.99,calcularTotalPedido($productos));
        //No tiene en cuenta el envio
        $this->assertNotEquals(13,calcularTotalPedido($productos));
    }
